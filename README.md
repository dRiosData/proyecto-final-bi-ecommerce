# Proyecto Final Integrador — Business Intelligence (E-commerce)
...
- Ingresos totales (ventas completas): **$87.729,89** / 2.523 transacciones / ticket promedio **$34,77**.
- Ventas mensuales estables entre febrero y diciembre (±8%), con pico en diciembre.
- **Carnicería** concentra el 27% de los ingresos; **Buenos Aires** el 37%.
- **NOA** tiene el ticket promedio más alto ($40,49) pese a ser la región con menor volumen.
- ~16% de las transacciones no llegan a completarse (Pendiente/Cancelada), con Patagonia como la región más afectada.
